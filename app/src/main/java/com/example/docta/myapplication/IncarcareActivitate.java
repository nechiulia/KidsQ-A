...
public class IncarcareActivitate extends AppCompatActivity {
    private ImageView imgTrannzitie;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_incarcare_activitate);
        ...
        Thread timer = new Thread(){
            public void run(){
                try {
                    ...
                    startActivity(new Intent(getApplicationContext(),PrincipalaActivitate.class));
                    finish();
                }
            }
        };
